...
export const useUserMeta = () => {
    ...
    const userMetas = useState<Record<string, { avatarId?: string; location?: string }>>("userMeta:metas", () => ({}));
     ...
     * @returns 元信息值或null
     */
    const getUserMeta = (userId: string, key: "avatarId" | "location", fallback?: string): string | null => {
     ...
     * @param value 元信息值
     */
    const setUserMeta = (userId: string, key: "avatarId" | "location", value: string) => {
