...
<template>
    <UButton :ui="{ leadingIcon: 'size-4' }" color="neutral" variant="soft" :icon="icon" :label="text ? text : label"
        tabindex="-1" class="capitalize rounded-sm hover:bg-neutral-200 hover:dark:bg-neutral-800 text-xs select-none"
